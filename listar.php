...
<table id="tabela" >
  ...
  <tr>
    ...
    <td>tipo</td>
    <td colspan="2">
    <a class="novo" href="inserir.php">Novo Contato</a>
   </td>
  </tr>
  </thead>
...
<?php while($resposta = $result->fetch_object()): ?>
  ...
  <tr>
    ...
    <td><?= $resposta->sexo ?></td>
    <td><?= $resposta->tipo ?></td>
    <td><a class="altera" href="alterar.php?id_cont=<?= $resposta->id_cont ?>">Alterar</a></td>
    <td><a class="delete" href="excluir.php?id_cont=<?= $resposta->id_cont ?>">Excluir</a></td>
